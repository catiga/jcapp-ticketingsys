...
public class TicketingSaleService {
	public static final TicketingSaleService INSTANCE = new TicketingSaleService();
	...
	def getreserveTicketSeat(BigInteger order_id){
	...
	public TicketSaleInfo get_ticketingsys_saleinfo_item_list(def order_no){
		String sql = "select * from TicketSaleInfo where order_no = ?";
		return jcTemplate.get(TicketSaleInfo, sql, order_no);
	}
	...
	public TicketReserveInfo get_ticketingsysreserveinfo_item(def order_no){
		String sql = "select * from TicketReserveInfo where order_no = ?";
		return jcTemplate.get(TicketReserveInfo, sql, order_no);
	}
