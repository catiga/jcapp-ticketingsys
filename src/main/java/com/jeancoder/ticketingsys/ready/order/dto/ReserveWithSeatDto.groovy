...
class ReserveWithSeatDto {
	...
	private List<ReserveSeatItemDto> seats;
	public Long getId() {
		return id;
	}
	...
	public List<ReserveSeatItemDto> getSeats() {
		return seats;
	}
	public void setSeats(List<ReserveSeatItemDto> seats) {
		this.seats = seats;
	}
}
