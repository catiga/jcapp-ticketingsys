...
public class DataTcSsMovieInfo {
	
	public DataTcSsMovieInfo() {
	}
	...
	public BigDecimal getFilm_score() {
		return film_score;
	}
	public void setFilm_score(BigDecimal film_score) {
