...
class CouponPrefer extends Prefer {
	...
	SimpleAjax compute(def order_param, Object uni_code, def op, Object de_list) {
		...
		def param = [card_code:uni_code,g:de_list,film_no:film_no,hall_id:hall_id.toString()];
		...
		try {
			...
			def ret_json = JC.internal.call('market', '/coupon/compute_movie_price', request_param)
