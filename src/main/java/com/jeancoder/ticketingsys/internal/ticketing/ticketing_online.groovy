...
import com.jeancoder.ticketingsys.ready.order.Ticketing_Online_Service
...
try{
	...
	orderPage = Ticketing_Online_Service.INSTANCE.getTicketReserveList(orderPage, pid, start_data, end_data, order_status);
	//处理数据
